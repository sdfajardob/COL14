...
- the analysis code in `R/` (licensed separately under the MIT License — see
  `LICENSE`); or
- the third-party palaeoclimate series in `data/paleoclimate/`, which remain
  the property of their original authors and are subject to the terms of the
  publications cited in `data/paleoclimate/README.md`.
